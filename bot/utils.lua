...
local lang = redis:get(hash)
  ...
  if not lang then
    return 'ðâ Ø§ÙÙØ¬ÙÙØ¹ÙÙ ÙÙ ÙØªÙÙÙ ØªÙØ¹ÙÙÙØ§ ð'
else
    return 'ðâ Ø§ÙÙØ¬ÙÙØ¹ÙÙ ÙÙ ÙØªÙÙÙ ØªÙØ¹ÙÙÙØ§ ð'
   end
  end
  ...
  if next(data[tostring(chat_id)]['banned']) == nil then --fix way
     if not lang then
					return "*ðâð¨âÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°Ø­ÙÙ°ÙØ¸ÙÙÙÙÙà«­ÙØ±Ù°ÙÙÙ°ÙÙÙÙÙ°  ÙÙÙ°ÙØ§Ø±Ù°ÙØºÙÙ°ÙÙ  âð¼*"
   else
					return "*ðâð¨âÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°Ø­ÙÙ°ÙØ¸ÙÙÙÙÙà«­ÙØ±Ù°ÙÙÙ°ÙÙÙÙÙ°  ÙÙÙ°ÙØ§Ø±Ù°ÙØºÙÙ°ÙÙ  âð¼*"
              end
				end
       if not lang then
   message = '_ðâð¨âÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°Ø­ÙÙ°ÙØ¸ÙÙÙÙÙà«­ÙØ±Ù°ÙÙÙ°ÙÙÙÙÙ°  á´Ì ð|â¡Â :_\n'
         else
   message = '_ðâð¨âÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°Ø­ÙÙ°ÙØ¸ÙÙÙÙÙà«­ÙØ±Ù°ÙÙÙ°ÙÙÙÙÙ°  á´Ì ð|â¡Â :_\n'
     end
...
local lang = redis:get(hash)
  ...
  if next(data[tostring(chat_id)]['is_silent_users']) == nil then --fix way
        if not lang then
					return "*ââÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°ÙÙÙ°ØªÙÙ°ÙÙà«­ÙÙÙÙ°ÙÙ°ÙÙÙÙÙ°   ÙÙÙ°ÙØ§Ø±Ù°ÙØºÙÙ°ÙÙ  âð¼*"
   else
					return "*ââÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°ÙÙÙ°ØªÙÙ°ÙÙà«­ÙÙÙÙ°ÙÙ°ÙÙÙÙÙ°   ÙÙÙ°ÙØ§Ø±Ù°ÙØºÙÙ°ÙÙ  âð¼*"
             end
				end
      if not lang then
   message = '_ââÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°ÙÙÙ°ØªÙÙ°ÙÙà«­ÙÙÙÙ°ÙÙ°ÙÙÙÙÙ°  ââ¡ï¸âÖâ_\n'
       else
   message = '_ââÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙÙÙÙ°ÙÙÙ°ØªÙÙ°ÙÙà«­ÙÙÙÙ°ÙÙ°ÙÙÙÙÙ°  ââ¡ï¸âÖâ_\n'
    end
...
local lang = redis:get(hash)
  ...
  if not data[tostring(chat_id)] then
  if not lang then
    return 'ÃÂ¯ÃÂ±ÃÂÃÂ ÃÂ¨ÃÂ ÃÂÃÂÃÂ³ÃÂª ÃÂ¯ÃÂ±ÃÂÃÂ ÃÂÃÂ§ÃÂ ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂªÃÂ ÃÂ±ÃÂ¨ÃÂ§ÃÂª ÃÂ§ÃÂ¶ÃÂ§ÃÂÃÂ ÃÂÃÂ´ÃÂ¯ÃÂ ÃÂ§ÃÂ³ÃÂª'
else
    return 'ÃÂ¯ÃÂ±ÃÂÃÂ ÃÂ¨ÃÂ ÃÂÃÂÃÂ³ÃÂª ÃÂ¯ÃÂ±ÃÂÃÂ ÃÂÃÂ§ÃÂ ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂªÃÂ ÃÂ±ÃÂ¨ÃÂ§ÃÂª ÃÂ§ÃÂ¶ÃÂ§ÃÂÃÂ ÃÂÃÂ´ÃÂ¯ÃÂ ÃÂ§ÃÂ³ÃÂª'
   end
  end
  ...
  if next(data[tostring(chat_id)]['whitelist']) == nil then --fix way
     if not lang then
					return "*ÃÂÃÂÃÂ ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ±ÃÂ ÃÂ¯ÃÂ± ÃÂÃÂÃÂ³ÃÂª ÃÂ³ÃÂÃÂÃÂ¯ ÃÂÃÂ¬ÃÂÃÂ¯ ÃÂÃÂ¯ÃÂ§ÃÂ±ÃÂ¯*"
   else
					return "*ÃÂÃÂÃÂ ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ±ÃÂ ÃÂ¯ÃÂ± ÃÂÃÂÃÂ³ÃÂª ÃÂ³ÃÂÃÂÃÂ¯ ÃÂÃÂ¬ÃÂÃÂ¯ ÃÂÃÂ¯ÃÂ§ÃÂ±ÃÂ¯*"
              end
				end
       if not lang then
   message = '_ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ±ÃÂ§ÃÂ ÃÂÃÂÃÂ³ÃÂª ÃÂ³ÃÂÃÂÃÂ¯ :_\n'
         else
   message = '_ÃÂ©ÃÂ§ÃÂ±ÃÂ¨ÃÂ±ÃÂ§ÃÂ ÃÂÃÂÃÂ³ÃÂª ÃÂ³ÃÂÃÂÃÂ¯ :_\n'
     end
...
local lang = redis:get(hash)
  ...
  if next(data['gban_users']) == nil then --fix way
    if not lang then
					return "*â¡ï¸â ÙÙÙ°Ø§Ø¦ÙÙÙ°Ù Ø§ÙÙ°ÙØ¹Ø§ÙÙÙ°  ÙÙÙ°ÙØ§Ø±Ù°ÙØºÙÙ°ÙÙ  âð¼*"
   else
					return "*â¡ï¸â ÙÙÙ°Ø§Ø¦ÙÙÙ°Ù Ø§ÙÙ°ÙØ¹Ø§ÙÙÙ°  ÙÙÙ°ÙØ§Ø±Ù°ÙØºÙÙ°ÙÙ  âð¼*"
             end
				end
        if not lang then
   message = '_ð±â ÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙØ­ÙÙ°ÙØ¸ÙÙÙÙØ±Ù°Ù Ø¹Ø§ÙÙÙ°  â¿â£_\n'
   else
   message = '_ð±â ÙÙÙ°Ø§Ø¦ÙÙÙ°Ø© Ø§ÙÙ°ÙØ­ÙÙ°ÙØ¸ÙÙÙÙØ±Ù°Ù Ø¹Ø§ÙÙÙ°  â¿â£_\n'
   end
...
local lang = redis:get(hash)
  ...
  if next(data[tostring(msg.chat_id_)]['filterlist']) == nil then --fix way
      if not lang then
    return "\n_ð³âÙØ§ ØªÙØ¬Ø¯ ÙÙÙØ§Øª ÙÙ Ø§ÙÙØ§Ø¦ÙÙ _"
      else
    return "\n_ð³âÙØ§ ØªÙØ¬Ø¯ ÙÙÙØ§Øª ÙÙ Ø§ÙÙØ§Ø¦ÙÙ _"
     end
  end
  if not data[tostring(msg.chat_id_)]['filterlist'] then
    ...
    save_data(_config.moderation.data, data)
      ...
      if not lang then
       filterlist = '\n ðâ ÙØ§Ø¦ÙÙÙÙ Ø§ÙÙÙÙÙØ¹ '
         else
       filterlist = '\n ðâ ÙØ§Ø¦ÙÙÙÙ Ø§ÙÙÙÙÙØ¹ '
    end
 local i = 1

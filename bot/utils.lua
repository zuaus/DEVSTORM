...
local lang = redis:get(hash)
  ...
  if not lang then
    return 'Ã°ÂÂÂÃ¢ÂÂ ÃÂ§ÃÂÃÂÃÂ¬ÃÂÃÂÃÂ¹ÃÂÃÂ ÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂ ÃÂªÃÂÃÂ¹ÃÂÃÂÃÂÃÂ§ Ã°ÂÂÂ'
else
    return 'Ã°ÂÂÂÃ¢ÂÂ ÃÂ§ÃÂÃÂÃÂ¬ÃÂÃÂÃÂ¹ÃÂÃÂ ÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂ ÃÂªÃÂÃÂ¹ÃÂÃÂÃÂÃÂ§ Ã°ÂÂÂ'
   end
  end
  ...
  if next(data[tostring(chat_id)]['banned']) == nil then --fix way
     if not lang then
					return "*Ã°ÂÂÂÃ¢ÂÂÃ°ÂÂÂ¨Ã¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂ­ÃÂÃÂ°ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃ Â«Â­ÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°  ÃÂÃÂÃÂ°ÃÂÃÂ§ÃÂ±ÃÂ°ÃÂÃÂºÃÂÃÂ°ÃÂÃÂ  Ã¢ÂÂÃ°ÂÂÂ¼*"
   else
					return "*Ã°ÂÂÂÃ¢ÂÂÃ°ÂÂÂ¨Ã¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂ­ÃÂÃÂ°ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃ Â«Â­ÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°  ÃÂÃÂÃÂ°ÃÂÃÂ§ÃÂ±ÃÂ°ÃÂÃÂºÃÂÃÂ°ÃÂÃÂ  Ã¢ÂÂÃ°ÂÂÂ¼*"
              end
				end
       if not lang then
   message = '_Ã°ÂÂÂÃ¢ÂÂÃ°ÂÂÂ¨Ã¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂ­ÃÂÃÂ°ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃ Â«Â­ÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°  Ã¡Â´ÂÃÂ Ã°ÂÂÂ|Ã¢ÂÂ¡ÃÂ :_\n'
         else
   message = '_Ã°ÂÂÂÃ¢ÂÂÃ°ÂÂÂ¨Ã¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂ­ÃÂÃÂ°ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃ Â«Â­ÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°  Ã¡Â´ÂÃÂ Ã°ÂÂÂ|Ã¢ÂÂ¡ÃÂ :_\n'
     end
...
local lang = redis:get(hash)
  ...
  if next(data[tostring(chat_id)]['is_silent_users']) == nil then --fix way
        if not lang then
					return "*Ã¢ÂÂÃ¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂ°ÃÂªÃÂÃÂ°ÃÂÃÂÃ Â«Â­ÃÂÃÂÃÂÃÂ°ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°   ÃÂÃÂÃÂ°ÃÂÃÂ§ÃÂ±ÃÂ°ÃÂÃÂºÃÂÃÂ°ÃÂÃÂ  Ã¢ÂÂÃ°ÂÂÂ¼*"
   else
					return "*Ã¢ÂÂÃ¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂ°ÃÂªÃÂÃÂ°ÃÂÃÂÃ Â«Â­ÃÂÃÂÃÂÃÂ°ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°   ÃÂÃÂÃÂ°ÃÂÃÂ§ÃÂ±ÃÂ°ÃÂÃÂºÃÂÃÂ°ÃÂÃÂ  Ã¢ÂÂÃ°ÂÂÂ¼*"
             end
				end
      if not lang then
   message = '_Ã¢ÂÂÃ¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂ°ÃÂªÃÂÃÂ°ÃÂÃÂÃ Â«Â­ÃÂÃÂÃÂÃÂ°ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°  Ã¢ÂÂÃ¢ÂÂ¡Ã¯Â¸ÂÃ¢ÂÂÃÂÃ¢ÂÂ_\n'
       else
   message = '_Ã¢ÂÂÃ¢ÂÂÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂ°ÃÂªÃÂÃÂ°ÃÂÃÂÃ Â«Â­ÃÂÃÂÃÂÃÂ°ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂ°  Ã¢ÂÂÃ¢ÂÂ¡Ã¯Â¸ÂÃ¢ÂÂÃÂÃ¢ÂÂ_\n'
    end
...
local lang = redis:get(hash)
  ...
  if not data[tostring(chat_id)] then
  if not lang then
    return 'ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂª ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂªÃÂÃÂ ÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂ¶ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂª'
else
    return 'ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂª ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂªÃÂÃÂ ÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂ¶ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂª'
   end
  end
  ...
  if next(data[tostring(chat_id)]['whitelist']) == nil then --fix way
     if not lang then
					return "*ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ©ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ± ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂª ÃÂÃÂ³ÃÂÃÂÃÂÃÂÃÂÃÂ¯ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ¯*"
   else
					return "*ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ©ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ± ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂª ÃÂÃÂ³ÃÂÃÂÃÂÃÂÃÂÃÂ¯ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ¯*"
              end
				end
       if not lang then
   message = '_ÃÂÃÂ©ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂª ÃÂÃÂ³ÃÂÃÂÃÂÃÂÃÂÃÂ¯ :_\n'
         else
   message = '_ÃÂÃÂ©ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂª ÃÂÃÂ³ÃÂÃÂÃÂÃÂÃÂÃÂ¯ :_\n'
     end
...
local lang = redis:get(hash)
  ...
  if next(data['gban_users']) == nil then --fix way
    if not lang then
					return "*Ã¢ÂÂ¡Ã¯Â¸ÂÃ¢ÂÂ ÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ ÃÂ§ÃÂÃÂ°ÃÂÃÂ¹ÃÂ§ÃÂÃÂÃÂ°  ÃÂÃÂÃÂ°ÃÂÃÂ§ÃÂ±ÃÂ°ÃÂÃÂºÃÂÃÂ°ÃÂÃÂ  Ã¢ÂÂÃ°ÂÂÂ¼*"
   else
					return "*Ã¢ÂÂ¡Ã¯Â¸ÂÃ¢ÂÂ ÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ ÃÂ§ÃÂÃÂ°ÃÂÃÂ¹ÃÂ§ÃÂÃÂÃÂ°  ÃÂÃÂÃÂ°ÃÂÃÂ§ÃÂ±ÃÂ°ÃÂÃÂºÃÂÃÂ°ÃÂÃÂ  Ã¢ÂÂÃ°ÂÂÂ¼*"
             end
				end
        if not lang then
   message = '_Ã°ÂÂÂ±Ã¢ÂÂ ÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂ­ÃÂÃÂ°ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂ±ÃÂ°ÃÂ ÃÂ¹ÃÂ§ÃÂÃÂÃÂ°  Ã¢ÂÂ¿Ã¢ÂÂ£_\n'
   else
   message = '_Ã°ÂÂÂ±Ã¢ÂÂ ÃÂÃÂÃÂ°ÃÂ§ÃÂ¦ÃÂÃÂÃÂ°ÃÂ© ÃÂ§ÃÂÃÂ°ÃÂÃÂ­ÃÂÃÂ°ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂ±ÃÂ°ÃÂ ÃÂ¹ÃÂ§ÃÂÃÂÃÂ°  Ã¢ÂÂ¿Ã¢ÂÂ£_\n'
   end
...
local lang = redis:get(hash)
  ...
  if next(data[tostring(msg.chat_id_)]['filterlist']) == nil then --fix way
      if not lang then
    return "\n_Ã°ÂÂÂ³Ã¢ÂÂÃÂÃÂ§ ÃÂªÃÂÃÂ¬ÃÂ¯ ÃÂÃÂÃÂÃÂ§ÃÂª ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂ§ÃÂ¦ÃÂÃÂ _"
      else
    return "\n_Ã°ÂÂÂ³Ã¢ÂÂÃÂÃÂ§ ÃÂªÃÂÃÂ¬ÃÂ¯ ÃÂÃÂÃÂÃÂ§ÃÂª ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂ§ÃÂ¦ÃÂÃÂ _"
     end
  end
  if not data[tostring(msg.chat_id_)]['filterlist'] then
    ...
    save_data(_config.moderation.data, data)
      ...
      if not lang then
       filterlist = '\n Ã°ÂÂÂÃ¢ÂÂ ÃÂÃÂ§ÃÂ¦ÃÂÃÂÃÂÃÂ ÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ '
         else
       filterlist = '\n Ã°ÂÂÂÃ¢ÂÂ ÃÂÃÂ§ÃÂ¦ÃÂÃÂÃÂÃÂ ÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ '
    end
 local i = 1
